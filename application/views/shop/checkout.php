                ...
                <div class="col-md-8">
                    <div class="product-content-right">
                        <div class="woocommerce">
                            ...
                            <form enctype="multipart/form-data" action="<?php echo site_url('Users/newOrder'); ?>" class="checkout" method="post" name="checkout">
                                    ...
                                    <div class="col-1">
                                        <div class="woocommerce-billing-fields">
                                            ...
                                            <p id="billing_first_name_field" class="form-row form-row-first validate-required">
                                                ...
                                                <input type="text" value="<?php if($user!=NULL)echo $user->first; ?>" placeholder="" id="billing_first_name" name="billing_first_name" class="input-text ">
                                            </p>

                                            <p id="billing_last_name_field" class="form-row form-row-last validate-required">
                                                <label class="" for="billing_last_name">Last Name <abbr title="required" class="required">*</abbr>
                                                </label>
                                                <input type="text" value="<?php if($user!=NULL)echo $user->last; ?>" placeholder="" id="billing_last_name" name="billing_last_name" class="input-text ">
                                            </p>
                                            <div class="clear"></div>
                                            ...
                                            <p id="billing_address_1_field" class="form-row form-row-wide address-field validate-required">
                                                ...
                                                <input type="text" value="<?php if($billing!=NULL)echo $billing->address; ?>" placeholder="Street address" id="billing_address_1" name="billing_address_1" class="input-text ">
                                            </p>

                                            <p id="billing_city_field" class="form-row form-row-wide address-field validate-required" data-o_class="form-row form-row-wide address-field validate-required">
                                                <label class="" for="billing_city">Town / City <abbr title="required" class="required">*</abbr>
                                                </label>
                                                <input type="text" value="<?php if($billing!=NULL)echo $billing->city; ?>" placeholder="Town / City" id="billing_city" name="billing_city" class="input-text ">
                                            </p>

                                            <p id="billing_postcode_field" class="form-row form-row-last address-field validate-required validate-postcode" data-o_class="form-row form-row-last address-field validate-required validate-postcode">
                                                <label class="" for="billing_postcode">Postcode <abbr title="required" class="required">*</abbr>
                                                </label>
                                                <input type="text" value="<?php if($billing!=NULL)echo $billing->postcode; ?>" placeholder="Postcode / Zip" id="billing_postcode" name="billing_postcode" class="input-text ">
                                            </p>
                                            ...
                                            <p id="billing_email_field" class="form-row form-row-first validate-required validate-email">
                                                ...
                                                <input type="text" value="<?php if($user!=NULL)echo $user->email; ?>" placeholder="" id="billing_email" name="billing_email" class="input-text ">
                                            </p>

                                            <p id="billing_phone_field" class="form-row form-row-last validate-required validate-phone">
                                                <label class="" for="billing_phone">Phone <abbr title="required" class="required">*</abbr>
                                                </label>
                                                <input type="text" value="<?php if($billing!=NULL)echo $billing->phone; ?>" placeholder="" id="billing_phone" name="billing_phone" class="input-text ">
                                            </p>
                                            <div class="clear"></div>
                                    ...
                                    <table class="shop_table">
                                        ...
                                        <tbody>
                                            ...
                                            <tr class="cart_item">
                                                <td class="product-name">
                                                    <?php echo $secrow['name'];?> <strong class="product-quantity">× 1</strong> 
                                                </td>
                                        ...
                                        <tfoot>
                                            ...
                                            <tr class="cart-subtotal">
                                                <th>Cart Subtotal</th>
                                                <td><span class="amount"><?php echo "Rp ".number_format($total,0,",","."); ?></span>
                                                </td>
                                            </tr>
                                            <?php if($total != $ctotal){                                                  
                                            ?>
                                            ...
                                            <tr class="order-total">
                                                <th>Order Total</th>
                                                <td><strong><span class="amount"><?php echo "Rp ".number_format($ctotal,0,",","."); ?></span></strong> </td>
                                            </tr>
                                            <?php 
                                                }else{
                                            ...
                                            <tr class="order-total">
                                                <th>Order Total</th>
                                                <td><strong><span class="amount"><?php echo "Rp ".number_format($total,0,",","."); ?></span></strong> </td>
                                            </tr>
                                             <?php 
                                                }
                                              ?>
